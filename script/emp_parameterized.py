...
from utils import assert_utils, read_emp_add, query_emp, update_emp_data, delete_emp_data
import app
import logging
import pymysql
...
class EmpTest(unittest.TestCase):
    ...
    @parameterized.expand(read_emp_add)
    ...
    @parameterized.expand(update_emp_data)
    ...
    @parameterized.expand(delete_emp_data)
